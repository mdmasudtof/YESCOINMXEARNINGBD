...
def print_welcome_message():
  ...
  __  ____   ________          _____  _   _ _____ _   _  _____ ____  _____  
 |  \/  \ \ / /  ____|   /\   |  __ \| \ | |_   _| \ | |/ ____|  _ \|  __ \ 
 | \  / |\ V /| |__     /  \  | |__) |  \| | | | |  \| | |  __| |_) | |  | |
 | |\/| | > < |  __|   / /\ \ |  _  /| . ` | | | | . ` | | |_ |  _ <| |  | |
 | |  | |/ . \| |____ / ____ \| | \ \| |\  |_| |_| |\  | |__| | |_) | |__| |
 |_|  |_/_/ \_\______/_/    \_\_|  \_\_| \_|_____|_| \_|\_____|____/|_____/ 
  Author : MX EARNING BD                                                                           
YouTube : https://www.youtube.com/@MXEARNINGBD
 Telegram :  https://t.me/MXEARNINGBD                                                                          
          """)
...
def get_invitation(token):
    ...
    try:
        ...
        data = response.json()
        if data['code'] == 0:
            print(f"{Fore.BLUE + Style.BRIGHT} \n -\{Fore.WHITE + Style.BRIGHT} Invited by MX EARNING BD {Fore.BLUE + Style.BRIGHT}/-", flush=True)
